...
class Ecwid_Theme_2015 extends Ecwid_Theme_Base
{
	...
	public function on_ecwid_plugin_installed()
	{
		...
		if (strpos(implode(' ', $widgets['sidebar-1']), 'ecwidstorelink') === false) {
			array_unshift($widgets['sidebar-1'], 'ecwidstorelink-1');
			...
			update_option('widget_ecwidstorelink', array_merge($options, array(1 => array('label' => __('Store', 'ecwid-shopping-cart')))));
		}
	}
}
